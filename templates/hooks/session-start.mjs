#!/usr/bin/env node
// OMB Session Start Hook (Node.js)
...
async function checkForUpdates(currentVersion) {
  ...
  try {
    ...
    const response = await fetch('https://registry.npmjs.org/oh-my-black/latest', {
...
[OMB UPDATE AVAILABLE]

A new version of oh-my-black is available: v${updateInfo.latestVersion} (current: ${updateInfo.currentVersion})

To update, run: claude /install-plugin oh-my-black
