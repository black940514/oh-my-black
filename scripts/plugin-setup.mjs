...
console.log('[OMB] Running post-install setup...');
...
async function main() {
  ...
  // 3. Fallback
  console.log("[OMB] run /omb-setup to install properly");
}
...
console.log('[OMB] Installed HUD wrapper script');
...
try {
  ...
  console.log('[OMB] Configured HUD statusLine in settings.json');
} catch (e) {
  console.log('[OMB] Warning: Could not configure settings.json:', e.message);
}

console.log('[OMB] Setup complete! Restart Claude Code to activate HUD.');
