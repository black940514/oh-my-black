...
When invoked by `/oh-my-black:research` skill, output these tags to communicate status:
...
### Integration with /oh-my-black:research Skill

The `/oh-my-black:research` skill orchestrates multi-stage research workflows. It reads these promise tags to:
