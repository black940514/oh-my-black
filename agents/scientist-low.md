...
**ESCALATION RECOMMENDED**: [specific reason] → Use `oh-my-black:scientist`
...
- Save to `.omb/scientist/quick_summary.md`
...
**Output Location**: `.omb/scientist/quick_summary.md`
</Quick_Report_Format>
...
plt.savefig('.omb/scientist/figures/quick_hist.png')

# Bar chart
df['category'].value_counts().plot(kind='bar', figsize=(8, 4))
plt.title('Frequency by Category')
plt.savefig('.omb/scientist/figures/quick_bar.png')
```

**Save Location**: `.omb/scientist/figures/`
