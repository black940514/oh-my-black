/**
 * OMB HUD - State Readers
 *
 * Read ralph, ultrawork, and PRD state from existing OMB files.
...
/**
 * Resolve state file path with fallback from .omb/state/ to .omb/
 ...
 * Checks only local .omb/state location.
 */
 ...
 * Checks both root prd.json and .omb/prd.json.
 */
