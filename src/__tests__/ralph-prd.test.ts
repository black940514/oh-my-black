...
describe('Ralph PRD Module', () => {
  ...
  describe('findPrdPath', () => {
    ...
    it('should find prd.json in .omb directory', () => {
      const omcDir = join(testDir, '.omb');
    ...
    it('should prefer root over .omb', () => {
  ...
  describe('readPrd / writePrd', () => {
    ...
    it('should create .omb directory when writing', () => {
      writePrd(testDir, samplePrd);
      expect(existsSync(join(testDir, '.omb'))).toBe(true);
    });
  ...
  describe('markStoryComplete / markStoryIncomplete', () => {
    ...
    it('should return false when no prd exists', () => {
      rmSync(join(testDir, '.omb'), { recursive: true, force: true });
