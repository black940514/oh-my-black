...
describe('Ralph Progress Module', () => {
  ...
  describe('initProgress', () => {
    it('should create progress.txt in .omb directory', () => {
      expect(initProgress(testDir)).toBe(true);
      expect(existsSync(join(testDir, '.omb', PROGRESS_FILENAME))).toBe(true);
    });
  ...
  describe('readProgressRaw / readProgress', () => {
    ...
    it('should read progress from .omb directory', () => {
