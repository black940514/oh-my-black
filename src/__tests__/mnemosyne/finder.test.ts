...
describe('Skill Finder', () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(projectRoot, '.omb', 'skills'), { recursive: true });
  });
  ...
  it('should find project-level skills', () => {
    const skillPath = join(projectRoot, '.omb', 'skills', 'test-skill.md');
  ...
  it('should prioritize project skills over user skills', () => {
    ...
    const projectSkillPath = join(projectRoot, '.omb', 'skills', 'skill.md');
  ...
  it('should get skills directory for project scope', () => {
    ...
    expect(projectDir).toContain('.omb');
  ...
  it('should populate sourceDir for project skills', () => {
    ...
    expect(projectCandidate!.sourceDir).toBe(join(projectRoot, '.omb', 'skills'));
  });
  ...
  it('should respect depth limit for deep directories', () => {
    ...
    let deepDir = join(projectRoot, '.omb', 'skills');
    for (let i = 0; i < 15; i++) {
  ...
  it('should construct PROJECT_SKILLS_SUBDIR with path.join', () => {
    expect(PROJECT_SKILLS_SUBDIR).toBe(join('.omb', 'skills'));
  });
});
