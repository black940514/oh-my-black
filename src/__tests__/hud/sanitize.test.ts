...
describe('sanitizeOutput', () => {
  ...
  it('should handle complex HUD output', () => {
    const input = '\x1b[1m[OMB]\x1b[0m | \x1b[32m████░░░░░░\x1b[0m 40% | agents:3';
    expect(sanitizeOutput(input)).toBe('[OMB] | ####------ 40% | agents:3');
  });
  ...
  it('should handle real HUD multi-line output', () => {
    const input = `\x1b[1m[OMB]\x1b[0m | \x1b[2m5h:\x1b[0m\x1b[32m12%\x1b[0m | Ctx: \x1b[32m████░░░░░░\x1b[0m 40%
