...
export interface DaemonConfig {
  ...
  verbose?: boolean;
  /** State file path (default: ~/.omb/state/rate-limit-daemon.json) */
  stateFilePath?: string;
  /** PID file path (default: ~/.omb/state/rate-limit-daemon.pid) */
  pidFilePath?: string;
  /** Log file path (default: ~/.omb/state/rate-limit-daemon.log) */
  logFilePath?: string;
}
