 ...
 * - Local state: .omb/state/{name}.json
 * - Global state: ~/.omb/state/{name}.json
 *
 * Features:
...
const LOCAL_STATE_DIR = ".omb/state";
/**
...
const LEGACY_LOCATIONS: Record<string, string[]> = {
  boulder: [".omb/boulder.json"],
  autopilot: [".omb/autopilot-state.json"],
  "autopilot-state": [".omb/autopilot-state.json"],
  ralph: [".omb/ralph-state.json"],
  "ralph-state": [".omb/ralph-state.json"],
  "ralph-verification": [".omb/ralph-verification.json"],
  ultrawork: [".omb/ultrawork-state.json"],
  "ultrawork-state": [".omb/ultrawork-state.json"],
  ultraqa: [".omb/ultraqa-state.json"],
  "ultraqa-state": [".omb/ultraqa-state.json"],
  "hud-state": [".omb/hud-state.json"],
  prd: [".omb/prd.json"],
};
...
// Re-export ohmyblack schemas and helpers
export * from "./ohmyblack-schemas.js";
