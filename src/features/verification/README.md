...
This module provides a single source of truth for verification requirements and execution across all major OMB workflows. It standardizes the verification process and ensures consistent evidence collection.
...
if (checklist.summary?.verdict === 'approved') {
  ...
  console.log('[RALPH VERIFIED] Run /oh-my-black:cancel to exit.');
}
```
