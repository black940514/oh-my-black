...
// Agent Output - standard agent output schema and validation
export {
  // Functions
  validateAgentOutput,
  parseAgentOutput,
  ...
  type Evidence,
  type FileChange,
  type SelfValidationResult,
  type AgentOutputValidationResult
} from './agent-output/index.js';

// Team - team definition and management
export {
  // Functions - Team creation
  ...
  formatExecutionReportMarkdown,
  defaultTaskExecutor,
  // Functions - Auto-Composer
  TeamAutoComposer,
...
// Meta-Prompt - template engine for meta-prompt generation
export {
  // Classes
  TemplateEngine,
  MetaPromptGenerator,
