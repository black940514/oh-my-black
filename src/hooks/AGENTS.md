...
- Verify state persistence in `.omb/state/`
...
| Hook | State File |
|------|------------|
| autopilot | `.omb/state/autopilot-state.json` |
| ultrapilot | `.omb/state/ultrapilot-state.json` |
| ralph | `.omb/state/ralph-state.json` |
| swarm | `.omb/state/swarm-tasks.db` (SQLite) |
