...
describe("subagent-tracker", () => {
        ...
        agents: [
          {
            ...
            agent_type: "oh-my-black:executor",
  ...
  describe("getAgentDashboard", () => {
    ...
    it("should show tool count and last tool", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "oh-my-black:architect",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
            tool_usage: [
    ...
    it("should strip oh-my-black: prefix from agent type", () => {
      const state: SubagentTrackingState = {
        agents: [
          {
            agent_id: "test-123",
            agent_type: "oh-my-black:architect-high",
            started_at: new Date().toISOString(),
            parent_mode: "none",
            status: "running",
          },
      ...
      expect(dashboard).not.toContain("oh-my-black:architect-high");
    });
  });
    ...
    it("should detect file conflicts between agents", () => {
      const state: SubagentTrackingState = {
        agents: [
          ...
          {
            agent_id: "agent-2",
            agent_type: "oh-my-black:designer",
            started_at: new Date().toISOString(),
            parent_mode: "ultrawork",
            status: "running",
