...
describe('processHook - Environment Kill-Switches', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.DISABLE_OMB;
    delete process.env.OMB_SKIP_HOOKS;
    resetSkipHooksCache();
  });
  ...
  describe('DISABLE_OMB flag', () => {
    it('should return continue:true when DISABLE_OMB=1', async () => {
      process.env.DISABLE_OMB = '1';
    ...
    it('should return continue:true when DISABLE_OMB=true (string)', async () => {
      process.env.DISABLE_OMB = 'true';
    ...
    it('should process normally when DISABLE_OMB is not set', async () => {
      const input: HookInput = {
        sessionId: 'test-session',
        prompt: 'hello world',
        directory: '/tmp/test'
    ...
    it('should process normally when DISABLE_OMB=false', async () => {
      process.env.DISABLE_OMB = 'false';
  ...
  describe('OMB_SKIP_HOOKS flag', () => {
    it('should skip single hook type when specified', async () => {
      process.env.OMB_SKIP_HOOKS = 'pre-tool-use';
    ...
    it('should skip multiple hook types when comma-separated', async () => {
      process.env.OMB_SKIP_HOOKS = 'pre-tool-use,persistent-mode';
    ...
    it('should handle whitespace in OMB_SKIP_HOOKS', async () => {
      process.env.OMB_SKIP_HOOKS = ' pre-tool-use , persistent-mode ';
    ...
    it('should process normally when hook type is not in skip list', async () => {
      process.env.OMB_SKIP_HOOKS = 'persistent-mode';
    ...
    it('should process normally when OMB_SKIP_HOOKS is empty', async () => {
      process.env.OMB_SKIP_HOOKS = '';
  ...
  describe('Combined flags', () => {
    it('should respect DISABLE_OMB even if OMB_SKIP_HOOKS is set', async () => {
      process.env.DISABLE_OMB = '1';
      process.env.OMB_SKIP_HOOKS = 'keyword-detector';
  ...
  describe('Performance', () => {
    ...
    it('should have minimal overhead when DISABLE_OMB=1', async () => {
      process.env.DISABLE_OMB = '1';
  ...
  describe('All hook types', () => {
    ...
    it('should disable all hook types when DISABLE_OMB=1', async () => {
      process.env.DISABLE_OMB = '1';
