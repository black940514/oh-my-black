 ...
 * 2. Active ralph loop (until cancelled via /oh-my-black:cancel)
...
4. When FULLY complete (after Architect verification), run \`/oh-my-black:cancel\` to cleanly exit and clean up state files. If cancel fails, retry with \`/oh-my-black:cancel --force\`.
...
export async function checkPersistentModes(
  ...
  // See: https://github.com/black940514/oh-my-black/issues/213
