...
\`\`\`
Task(
  subagent_type="oh-my-black:analyst",
  model="opus",
...
Save to: .omb/plans/autopilot-impl.md
...
\`\`\`
Task(
  subagent_type="oh-my-black:critic",
  model="opus",
  prompt="REVIEW IMPLEMENTATION PLAN

Plan file: .omb/plans/autopilot-impl.md
...
Task(subagent_type="oh-my-black:executor-low", model="haiku", prompt="...")
...
Task(subagent_type="oh-my-black:executor-high", model="opus", prompt="...")
\`\`\`
...
\`\`\`
Task(
  subagent_type="oh-my-black:architect-low",
  model="haiku",
...
\`\`\`
Task(
  subagent_type="oh-my-black:build-fixer",
  model="sonnet",
...
// Security Review
Task(
  subagent_type="oh-my-black:security-reviewer",
  model="opus",
...
// Code Quality Review
Task(
  subagent_type="oh-my-black:code-reviewer",
  model="opus",
...
export function getPhasePrompt(
  ...
  switch (phase) {
    ...
    case 'planning':
      return getDirectPlanningPrompt(context.specPath || '.omb/autopilot/spec.md');
    case 'execution':
      return getExecutionPrompt(context.planPath || '.omb/plans/autopilot-impl.md');
    case 'qa':
      return getQAPrompt();
    case 'validation':
      return getValidationPrompt(context.specPath || '.omb/autopilot/spec.md');
    default:
      return '';
  }
}
