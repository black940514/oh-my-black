 ...
 * Skills Tools
 *
 * MCP tools for loading and listing OMB learned skills
 * from local (.omb/skills/) and global (~/.omb/skills/) directories.
 */
...
export const loadLocalTool = {
  ...
  description: 'Load and list skills from the project-local .omb/skills/ directory. Returns skill metadata (id, name, description, triggers, tags) for all discovered project-scoped skills.',
...
export const loadGlobalTool = {
  ...
  description: 'Load and list skills from global user directories (~/.omb/skills/ and ~/.claude/skills/omc-learned/). Returns skill metadata for all discovered user-scoped skills.',
...
/** All skills tools for registration in omb-tools-server */
