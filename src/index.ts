 ...
 * AI-powered orchestration with Zero Learning Curve.
 *
 * Main features:
 * - Intelligent orchestration: Primary orchestrator that delegates to specialized subagents
 ...
 * @example
 * ```typescript
 * import { createOmcSession } from 'oh-my-black';
