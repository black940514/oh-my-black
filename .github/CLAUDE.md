# Claude AI Instructions for oh-my-black
...
### Installation
```bash
/plugin marketplace add black940514/oh-my-black
```
...
### Installation Issues
- Recommend running `/oh-my-black:doctor` to diagnose problems
- Check if user installed via correct method: `/plugin marketplace add black940514/oh-my-black`
