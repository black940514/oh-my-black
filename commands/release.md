---
description: Automated release workflow for oh-my-black
---

# Release Skill

Automate the release process for oh-my-black.

## Usage

```
/oh-my-black:release <version>
```

Example: `/oh-my-black:release 2.4.0` or `/oh-my-black:release patch` or `/oh-my-black:release minor`
...
### 7. Verify
- [ ] npm: https://www.npmjs.com/package/oh-my-black
- [ ] GitHub: https://github.com/black940514/oh-my-black/releases
