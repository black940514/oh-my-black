...
**If NOT parallelizable:** Fall back to regular `/oh-my-black:autopilot`
...
Track state in `.omb/ultrapilot-state.json`:
...
When all phases complete and Architect validates, run `/oh-my-black:cancel` to cleanly exit ultrapilot and clean up state files.
