...
Create `.omb/prd.json` and `.omb/progress.txt` based on the task description.
...
After creating files, report summary and suggest running `/oh-my-black:ralph-loop` to start.
