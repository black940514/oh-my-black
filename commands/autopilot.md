...
Combine Analyst + Architect output into `.omb/autopilot/spec.md`
...
- **ONLY** write directly to `.omb/`, `.claude/`, `CLAUDE.md`, `AGENTS.md`
...
When all phases complete successfully, run `/oh-my-black:cancel` to cleanly exit autopilot and clean up state files.
