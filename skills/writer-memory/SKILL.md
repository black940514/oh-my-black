...
| Command | Action |
|---------|--------|
| `/oh-my-black:writer-memory init <project-name>` | Initialize new project memory |
| `/oh-my-black:writer-memory status` | Show memory overview (character count, scene count, etc) |
| `/oh-my-black:writer-memory char add <name>` | Add new character |
| `/oh-my-black:writer-memory char <name>` | View character details |
| `/oh-my-black:writer-memory char update <name> <field> <value>` | Update character field |
| `/oh-my-black:writer-memory char list` | List all characters |
| `/oh-my-black:writer-memory rel add <char1> <char2> <type>` | Add relationship |
| `/oh-my-black:writer-memory rel <char1> <char2>` | View relationship |
| `/oh-my-black:writer-memory rel update <char1> <char2> <event>` | Add relationship event |
| `/oh-my-black:writer-memory scene add <title>` | Add new scene |
| `/oh-my-black:writer-memory scene <id>` | View scene details |
| `/oh-my-black:writer-memory scene list` | List all scenes |
| `/oh-my-black:writer-memory theme add <name>` | Add theme |
| `/oh-my-black:writer-memory world set <field> <value>` | Set world attribute |
| `/oh-my-black:writer-memory query <question>` | Query memory naturally (Korean supported) |
| `/oh-my-black:writer-memory validate <character> <dialogue>` | Check if dialogue matches character tone |
| `/oh-my-black:writer-memory synopsis` | Generate emotion-focused synopsis |
| `/oh-my-black:writer-memory export` | Export full memory as readable markdown |
| `/oh-my-black:writer-memory backup` | Create manual backup |
...
### With OMB Notepad System
Writer Memory integrates with `.omb/notepad.md`:
...
```
Task(subagent_type="oh-my-black:architect",
     model="opus",
