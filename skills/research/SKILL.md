...
```
/oh-my-black:research <goal>                    # Standard research with user checkpoints
/oh-my-black:research AUTO: <goal>              # Fully autonomous until complete
/oh-my-black:research status                    # Check current research session status
/oh-my-black:research resume                    # Resume interrupted research session
/oh-my-black:research list                      # List all research sessions
/oh-my-black:research report <session-id>       # Generate report for session
```

### Quick Examples

```
/oh-my-black:research What are the performance characteristics of different sorting algorithms?
/oh-my-black:research AUTO: Analyze authentication patterns in this codebase
/oh-my-black:research How does the error handling work across the API layer?
```
...
Task(subagent_type="oh-my-black:scientist-low", model="haiku", prompt="[RESEARCH_STAGE:1] Investigate...")

// Stage 2 - Standard analysis
Task(subagent_type="oh-my-black:scientist", model="sonnet", prompt="[RESEARCH_STAGE:2] Analyze...")

// Stage 3 - Complex reasoning
Task(subagent_type="oh-my-black:scientist-high", model="opus", prompt="[RESEARCH_STAGE:3] Deep analysis of...")
```
...
Task(subagent_type="oh-my-black:scientist", model="sonnet", prompt="
...
4. **Cancellation:** `/oh-my-black:cancel` or "stop", "cancel"

### AUTO Mode Example

```
/oh-my-black:research AUTO: Comprehensive security analysis of the authentication system
...
Task(subagent_type="oh-my-black:scientist-low", model="haiku", prompt="[STAGE:1] Analyze src/api/...")
Task(subagent_type="oh-my-black:scientist-low", model="haiku", prompt="[STAGE:2] Analyze src/utils/...")
Task(subagent_type="oh-my-black:scientist-low", model="haiku", prompt="[STAGE:3] Analyze src/components/...")
```
...
Task(subagent_type="oh-my-black:scientist", model="sonnet", prompt="[HYPOTHESIS:A] Test if caching improves...")
Task(subagent_type="oh-my-black:scientist", model="sonnet", prompt="[HYPOTHESIS:B] Test if batching reduces...")
Task(subagent_type="oh-my-black:scientist", model="sonnet", prompt="[HYPOTHESIS:C] Test if lazy loading helps...")
```
...
Task(subagent_type="oh-my-black:scientist-high", model="opus", prompt="
[CROSS_VALIDATION]
...
| Command | Action |
|---------|--------|
| `/oh-my-black:research status` | Show current session progress |
| `/oh-my-black:research resume` | Resume most recent interrupted session |
| `/oh-my-black:research resume <session-id>` | Resume specific session |
| `/oh-my-black:research list` | List all sessions with status |
| `/oh-my-black:research report <session-id>` | Generate/regenerate report |
| `/oh-my-black:research cancel` | Cancel current session (preserves state) |
...
Progress is preserved in `.omb/research/{session-id}/` for resume.
