...
Use /oh-my-black:learner ONLY after:
...
- **Project-level**: .omb/skills/ - Default. Version-controlled with repo.
...
- /oh-my-black:note - Save quick notes that survive compaction (less formal than skills)
- /oh-my-black:ralph - Start a development loop with learning capture
