...
1. Read the plan file from `.omb/plans/`
...
Task(subagent_type="oh-my-black:analyst", model="opus", prompt="Analyze requirements...")
...
- Drafts are saved to `.omb/drafts/`
- Final plans are saved to `.omb/plans/`
