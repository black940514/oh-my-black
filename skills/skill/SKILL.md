...
Meta-skill for managing oh-my-black skills via CLI-like commands.
...
2. Scan project skills at `.omb/skills/`
...
5. **Ask for scope:**
   ...
   - `project` → `.omb/skills/<name>/SKILL.md`
...
User: yes
Assistant: ✓ Copied 'error-handler' to .omb/skills/
