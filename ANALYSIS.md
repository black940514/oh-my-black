...
**Hephaestus** (oh-my-opencode) and **Deep-Executor** (oh-my-black) are both autonomous deep worker agents designed for complex, goal-oriented software engineering tasks. Deep-Executor is explicitly ported from Hephaestus (PR #1287) but has been adapted to fit the oh-my-black framework.
...
### Comparison
| Aspect | Hephaestus (OMO) | Deep-Executor (OMB) |
|--------|------------------|---------------------|
...
- Follows existing OMB patterns (ultrawork, pipeline)
...
## Appendix A: Implementation Checklist for OMB
...
1. **Primary Source**: oh-my-black local codebase
