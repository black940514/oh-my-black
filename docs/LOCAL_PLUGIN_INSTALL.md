...
How to install oh-my-black from a local development directory as a Claude Code plugin.

## Quick Install

```bash
# 1. Add local directory as a marketplace
claude plugin marketplace add /path/to/oh-my-black
...
claude plugin marketplace update oh-my-black

# Update the installed plugin
claude plugin update oh-my-black@oh-my-black

# List installed plugins
claude plugin list

# Uninstall
claude plugin uninstall oh-my-black@oh-my-black

# Remove marketplace
claude plugin marketplace remove oh-my-black
```
