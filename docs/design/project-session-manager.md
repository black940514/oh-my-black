...
```bash
# Review PR #123 from oh-my-black repo
/psm review omc#123
...
// ~/.psm/projects.json
{
  "aliases": {
    "omc": {
      "repo": "anthropics/oh-my-black",
      "local": "~/Workspace/oh-my-black",
      "default_base": "main"
    },
    "cc": {
...
// .psm-session.json
{
  ...
  "source_repo": "~/Workspace/oh-my-black",
  "github": {
    "pr_number": 123,
    "pr_title": "Add webhook support",
    "pr_author": "contributor",
    "pr_url": "https://github.com/anthropics/oh-my-black/pull/123"
  },
  "state": "active",
  "notes": []
}
...
### 10.1 OMB Skill Integration

| OMB Skill | PSM Integration |
|-----------|-----------------|
...
PSM status in OMB HUD statusline:
...
🔍 Fetching PR #123 from oh-my-black...
