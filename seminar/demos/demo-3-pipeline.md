...
```
/oh-my-black:pipeline review
```

Or demonstrate custom pipeline:
```
/oh-my-black:pipeline explore:haiku -> architect:opus -> critic:opus -> executor:sonnet
```
...
```
/oh-my-black:pipeline explore:haiku -> architect:opus -> executor-high:opus -> qa-tester:sonnet
```
...
```bash
cat .omb/state/pipeline-state.json
```
