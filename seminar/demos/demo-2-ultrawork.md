...
**What happens:**
- OMB announces: "I'm activating ultrawork for maximum parallel execution..."
...
- "This is how OMB achieves 3-5x speedup on multi-file tasks"
...
- "OMB uses a file ownership coordinator - prevents two agents from editing the same file"
...
[HUD: OMB │ explore:1 scanning...]

Scanning codebase for TypeScript errors...
✓ Found 8 errors across 4 files (3s)

[HUD: OMB │ executor-low:4 active │ Tasks: 4/4 in progress]
...
[HUD: OMB │ build-fixer:1 active │ Verifying...]
...
**Solution:**
- Still good for demo! Point out: "OMB determined 3 agents was optimal for this workload"
...
**During scanning:**
```
OMB │ explore:1 scanning │ 0s
```

**During parallel execution:**
```
OMB │ executor-low:4 active │ Tasks: 4/4 in progress │ 18s
```

**During verification:**
```
OMB │ build-fixer:1 verifying │ 22s
```

**After completion:**
```
OMB │ idle │ Last: 4 agents, 1m34s
```
...
A: Yes! Use `/oh-my-black:swarm N:agent-type "task"` for explicit control. Ultrawork auto-determines the optimal number.
