...
**What happens:**
- OMB detects broad request: "authentication system" without specifics
- Plan skill activates
- Announces: "I'm starting a planning session - I'll interview you about requirements"

**Presenter talking points:**
- "OMB detected a broad request - 'authentication' could mean many things"
...
- "This plan is saved to `.omb/plans/auth-system.md`"
...
──────────
1. Review this plan
2. Modify if needed: edit .omb/plans/auth-system.md
...
```
/oh-my-black:review auth-system
```
...
A: Absolutely! Plans are saved as markdown in `.omb/plans/`. Edit the file, then execute it.
