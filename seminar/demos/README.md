# OMB Seminar Demo Scripts

This directory contains demo scripts for showcasing Oh-My-ClaudeCode's capabilities.

## Overview

The seminar includes 5 progressive demos that showcase different aspects of OMB:
...
### Required Setup
- OMB installed and configured (`/oh-my-black:omb-setup` completed)
- HUD statusline installed (`/oh-my-black:hud setup`)
...
# Verify OMB is installed
which omc || echo "Run: /oh-my-black:omb-setup"
...
- [ ] No active OMB operations running (`/oh-my-black:cancel --all`)
- [ ] Clean state files (`rm -rf .omb/state/*`)
...
### Closing (1 min)
"OMB transforms how you work with Claude - from manual coding to orchestrating specialized agents. All open source at github.com/black940514/oh-my-black."

## Tips for Presenters

### General Tips
- **Announce behaviors**: OMB announces what it's activating ("I'm activating autopilot...")
...
- **State cleanup**: Between demos, verify clean state with `/oh-my-black:cancel`
...
**Solution**: Check `.omb/logs/agent-lifecycle.log` for errors, or skip to fallback output

### Issue: HUD not showing
**Solution**: Mention it verbally ("The HUD would show 3 active agents here...")

### Issue: Demo taking too long
**Solution**: Jump to next phase or use `/oh-my-black:cancel` and show fallback
