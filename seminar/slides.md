...
---
# oh-my-black: Multi-Agent Orchestration for Claude Code
...
Note: This is a 60-minute seminar covering the complete oh-my-black system. We'll focus on practical usage patterns.
...
Note: These are real problems I faced building production applications with Claude Code. OMB was born from frustration with manually orchestrating AI-assisted development.
...
Note: OMB transforms Claude from a single performer into a conductor of an orchestra of specialized AI agents.
...
/oh-my-black:autopilot Add OAuth2 authentication
...
Note: The tier system is central to OMB's cost efficiency. Always start low and escalate only when needed.

---

## Smart Delegation

**OMB automatically picks the right agent:**
...
```javascript
Task(
  subagent_type="oh-my-black:executor-low",
  model="haiku",
...
Note: Composition is where OMB really shines - combine behaviors for exactly the workflow you need.
...
Plan saved to: .omb/plans/auth-system.md
```
...
**Real-time visibility into OMB state:**

```
+------------------------------------------------------------+
| OMB | autopilot:exec | 3 agents | 5/12 tasks | ctx:45% | $2.34 |
+------------------------------------------------------------+
      ^               ^          ^            ^         ^
      |               |          |            |         |
...
Note: Zero learning curve means you can start using OMB immediately after installation.
...
Note: Matching the right mode to the task type is key to getting the most out of OMB.
...
**GitHub Repository**
```
github.com/black940514/oh-my-black
```

**Website & Documentation**
```
github.com/black940514/oh-my-black-website
```
...
| Question | Answer |
|----------|--------|
| Does OMB work with Claude API keys? | Yes, both Max/Pro subscription and API keys work |
| Can I use OMB with other AI models? | No, OMB is specifically for Claude Code |
| How do I stop a runaway autopilot? | Say "stop", "cancel", or `/oh-my-black:cancel` |
| Why is my HUD not showing? | Run `/oh-my-black:hud setup` |
...
| omb-setup | Setup wizard | `/omb-setup` |
...
|----------|--------------|--------|
| `autopilot:` | `/oh-my-black:autopilot` | Full autonomous mode |
| `ralph:` | `/oh-my-black:ralph` | Persistence mode |
| `ulw` | `/oh-my-black:ultrawork` | Parallel execution |
| `eco:` | `/oh-my-black:ecomode` | Token-efficient mode |
| `plan` | `/oh-my-black:plan` | Planning interview |
