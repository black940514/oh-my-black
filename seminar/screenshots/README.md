# Screenshot Guide for OMB Seminar
...
│                                                                             │
│   📄 Output: .omb/autopilot/spec.md (428 lines)                            │
│                                                                             │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
...
│   ✓ Risk assessment: LOW                                                   │
│                                                                             │
│   📄 Output: .omb/plans/autopilot-impl.md (23 tasks)                       │
│                                                                             │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
...
**Description:** Split-screen comparison showing manual Claude Code usage on left vs. OMB orchestrated on right, demonstrating the difference in workflow.
...
```
┌─────────────────────────────────────┬─────────────────────────────────────┐
│ BEFORE: Manual Claude Code          │ AFTER: OMB Orchestration            │
├─────────────────────────────────────┼─────────────────────────────────────┤
...
**Capture Instructions:**
1. Ensure HUD is installed: `claude` then `/oh-my-black:hud setup`
...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│ 🎯 OMB HUD │ Agents: 3 active │ Todos: 8/15 done │ Tokens: 145K/200K │ 🟢   │
...
│ OMB│ 3 active │  8/15 done  │ 145K/200K    │  🟢    │
│ HUD│          │   (53%)     │   (73%)      │        │
└────┴──────────┴─────────────┴──────────────┴────────┘
...
1. Use a pipeline preset or custom pipeline:
   ```
   /oh-my-black:pipeline review "analyze the authentication system"
   ```
2. Capture showing each stage completing and passing data to next
3. Alternative: Check `.omb/logs/pipeline.log` for formatted output
...
1. Start swarm mode:
   ```
   /oh-my-black:swarm 5:executor "implement all CRUD operations"
   ```
2. Capture when agents are actively claiming tasks
3. Check `.omb/state/swarm-tasks.json` for task status
...
asciinema rec -t "OMB Autopilot Demo" autopilot-demo.cast
...
tmux new-session \; \
  ...
  select-pane -t 1 \; \
  send-keys "# AFTER: OMB workflow" C-m
```
