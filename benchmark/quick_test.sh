...
# Step 2: Run quick OMB test
log_step "Step 2/2: Quick OMB test ($TEST_LIMIT instances)..."
echo ""
...
if [ $VANILLA_STATUS -eq 0 ] && [ $OMB_STATUS -eq 0 ]; then
    ...
    [ $OMB_STATUS -ne 0 ] && log_error "  OMB test: FAILED (exit code $OMB_STATUS)"
    echo ""
